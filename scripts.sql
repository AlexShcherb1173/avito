...
INSERT INTO users (email, password, first_name, last_name, phone, role, enabled, image_url, created_at) VALUES
('VICTTTORYA00@gmail.com', '$2a$10$JPOL9UM7S4', 'Виктория', 'Чеботарева', '+7 (909) 123-45-67', 'ADMIN'),
('user@example.com', '$2a$10$rDkPvvAFV8kqwvKJzwlRv.i.q.wz1w1pz0SFsHn/55jNeZFQvyeAy', 'Максим', 'Турин', '+7 (904) 765-43-21', 'USER');

INSERT INTO ads (title, price, description, image_url, author_id, created_at) VALUES
