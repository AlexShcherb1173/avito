...
Прежде чем начать, убедитесь, что Docker установлен на вашем компьютере. Если Docker не установлен, следуйте инструкциям 
на [официальном сайте Docker](https://docs.docker.com/get-docker/).

## Сборка и запуск контейнеров

### Сборка образа бэкенда и запуск контейнера
...
1. Для запуска контейнера фронтенда, выполните команду:
    ...
    ```
Можно запустить локально из IDEA (при условии запущенной локально бд или контейнера с бд)
для этого необходимо загрузить файл .env в переменные окружения проекта
