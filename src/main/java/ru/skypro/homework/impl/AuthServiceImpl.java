...
public class AuthServiceImpl implements AuthService {
    ...
    private final UserDetailsManager userDetailService;
    private final PasswordEncoder encoder;
    private final UserRepository userRepository;

    public AuthServiceImpl(UserDetailsManager userDetailService, PasswordEncoder encoder, UserRepository userRepository) {
    ...
    public boolean register(Register register) {
        log.info("Запущен метод сервиса {}", RegisterServiceImpl.getMethodName());
